...
#ifndef GFAST_COPY_CONFIGURATION_HH
#define GFAST_COPY_CONFIGURATION_HH
...
extern void get_configuration(GtkWidget *window, GtkWidget *light, GtkWidget *dark, Configuration *config) ;
